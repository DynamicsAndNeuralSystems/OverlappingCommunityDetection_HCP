...
echo "g++ -static-libstdc++ -o oslom_undir $source_folder/main_undirected.cpp -O3 -Wall"
g++ -static-libstdc++ -o oslom_undir $source_folder/main_undirected.cpp -O3 -Wall

echo ""
echo "Compiling OSLOM directed (oslom_dir) ..."
echo "g++ -static-libstdc++ -o oslom_dir $source_folder/main_directed.cpp -O3 -Wall"
g++ -static-libstdc++ -o oslom_dir $source_folder/main_directed.cpp -O3 -Wall


echo ""
echo "Compiling program to write pajek format (pajek_write_undir) ..."
echo "g++ -static-libstdc++ -o pajek_write_undir $visual_folder/main_pajek.cpp -O3"
g++ -static-libstdc++ -o pajek_write_undir $visual_folder/main_pajek.cpp -O3


echo ""
echo "Compiling program to write pajek format (pajek_write_dir) ..."
echo "g++ -static-libstdc++ -o pajek_write_dir $visual_folder/main_pajek_directed.cpp -O3"
g++ -static-libstdc++ -o pajek_write_dir $visual_folder/main_pajek_directed.cpp -O3
...
make clean
make
g++ -static-libstdc++ -o infomap_scr infomap_scr.cpp -O3
cd ../..
...
g++ -static-libstdc++ script_to_compile.cpp
./a.out
g++ -static-libstdc++ -o louvain_script order.cpp -O3
cd ../..
